...
@Component
public class PriceGraphStrategyPattern implements GraphStrategyPattern {

    private final ExchangeInfoRepository exchangeInfoRepository;

    @Autowired
    public PriceGraphStrategyPattern(ExchangeInfoRepository exchangeInfoRepository) {
    ...
    public JsonNode generateGraph(int timeInterval) {
        ...
        List<Object[]> resultList = exchangeInfoRepository.fetchTrade(timestamp);
        ...
        for (Object[] row : resultList) {
            ...
            TradeValue tradeValue = (TradeValue) row[1];

            ObjectNode dataNode = objectMapper.createObjectNode();
            dataNode.put("mid", tradeValue.getMidValue());
