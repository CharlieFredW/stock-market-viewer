...
@Component
public class VolumeGraphStrategyPattern implements GraphStrategyPattern {

    private final ExchangeInfoRepository exchangeInfoRepository;

    @Autowired
    public VolumeGraphStrategyPattern(ExchangeInfoRepository exchangeInfoRepository) {
    ...
    public JsonNode generateGraph(int timeInterval) {
        ...
        for (Object[] row : resultList) {
            ...
            dataNode.put("volume", volume.getVolume());
